...
public class UmsMemberController {
    ...
    @ResponseBody
    public CommonResult register(@RequestParam(value="username", defaultValue="") String username,
    ...
    public CommonResult getUser(@RequestParam String userName) {
        UmsMember member =  memberService.getUser(userName);
        if(member == null) {
    ...
    @ResponseBody
    public CommonResult update(@RequestBody UmsMember userInfo) {
        return memberService.update(userInfo);
    }
}
