...
import org.flybird.rock.bo.AdminUserDetails;
import org.flybird.rock.dao.UmsAdminPermissionRelationDao;
import org.flybird.rock.dao.UmsAdminRoleRelationDao;
import org.flybird.rock.dto.UmsAdminParam;
import org.flybird.rock.dto.UpdateAdminPasswordParam;
import org.flybird.rock.mapper.UmsAdminLoginLogMapper;
import org.flybird.rock.mapper.UmsAdminMapper;
import org.flybird.rock.mapper.UmsAdminPermissionRelationMapper;
import org.flybird.rock.mapper.UmsAdminRoleRelationMapper;
import org.flybird.rock.model.*;
import org.flybird.rock.security.service.RedisService;
import org.flybird.rock.security.util.JwtTokenUtil;
...
public class UmsAdminServiceImpl implements UmsAdminService {
    ...
    @Override
    public int login(String username, String password, String key, String authCode, List<String> token) {
        //密码需要客户端加密后传递
        try {
            if(StringUtils.isEmpty(key)){
                return -1;
            }
            String realAuthCode = redisService.get(REDIS_KEY_PREFIX_AUTH_CODE + key);
...
//            }
            ...
            String tokenStr = jwtTokenUtil.generateToken(userDetails);
            token.add(tokenStr);
